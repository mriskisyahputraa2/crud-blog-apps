                    ...
                    <tbody>
                        {users.map((user, index) => (
                            <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                                <th scope="row" className="text-lg px-6 py-4 whitespace-nowrap dark:text-white">
                                    {index + 1}
                                </th>
                                ...
                                <td className="flex justify-center items-center space-x-4 ">
                                    <button className="px-6 py-2 bg-gray-900/75 text-white rounded-lg mt-2">View</button>
                                    <button className="px-6 py-2 bg-blue-500 text-white rounded-lg mt-2">Edit</button>
                                    <button className="px-6 py-2 bg-red-500 text-white rounded-lg mt-2">Delete</button>
                                </td>
                            </tr>
